    ...
    <div class="card-body p-4">
        ...
        <form action="{{ url('student/' .$students->id) }}" method="post">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary rounded-pill px-5 py-2 shadow-sm font-weight-bold" onclick="printForm()">Print</button>
            </div>
        </form>
...
function printForm() {
    ...
    printWindow.document.write('<!DOCTYPE html><html><head><title>Print Student Information</title></head><body>');
    printWindow.document.write('<div style="margin: 20px;">');
    printWindow.document.write('<h2>Student Information</h2>');
    printWindow.document.write('<p><strong>Name:</strong> ' + document.getElementById('name').value + '</p>');
    printWindow.document.write('<p><strong>Address:</strong> ' + document.getElementById('address').value + '</p>');
    printWindow.document.write('<p><strong>Mobile Number:</strong> ' + document.getElementById('mobile').value + '</p>');
